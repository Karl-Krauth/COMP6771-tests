...
void matt_tests() {
    ...
    assert(v1.getEuclideanNorm() == sqrt(14));
    v1[0] = 3;
    assert(v1[0] == 3 && v1.get(0) == 3);
    assert(v1.getEuclideanNorm() == sqrt(22));
    assert(v1.getEuclideanNorm() == sqrt(22));
    v1 = vec{3, 4}; // move assignment
    assert((v1 == vec{3, 4}));
    assert(v1.getEuclideanNorm() == 5);
    v1 *= 2;
    assert((v1 == vec{6, 8}));
    assert(v1.getEuclideanNorm() == 10);
    v1 /= 2;
    assert((v1 == vec{3, 4}));
    assert(v1.getEuclideanNorm() == 5);
    ...
    v1 += vec{1, 3};
    assert((v1 == vec{4, 7}));
    assert(v1.getEuclideanNorm() == sqrt(16 + 49));
    v1 -= vec{3, 1};
    assert((v1 == vec{1, 6}));
    assert(v1.getEuclideanNorm() == sqrt(37));
    ...
    assert(constVec.getEuclideanNorm() == 4);
